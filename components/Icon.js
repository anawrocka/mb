...
export default class Icon extends React.Component {
    ...
    render() {
        ...
        if( name === '*' ) {
            return <div>${Object.keys(this.icons).map((name) => {
                return <div>
                        {name}:
                        {this.icons[name](color)}
                        <br />
                    </div>
            })}</div>
        } else if(!this.icons[name]) {
            throw new Error('Icon name not supported: ' + name)
        }

        return this.icons[name](color)

    }

        icons = {
        logo: (color) => <svg xmlns="http://www.w3.org/2000/svg" width="740px" height="140px" viewBox="0 0 740 140" fill={color}>
                            <g>
                                <g>
                                    <g>
                                        <path d="M255.8,99.2V52.8h-0.2l-14.2,46.4h-14.7l-14.2-46.4h-0.2v46.4h-14.9V38.8h24.8L234,80h0.2l11.7-41.3h24.8
                                            v60.4H255.8z"/>
                                        <path d="M324.6,75.5c0,1.5-0.1,4.3-0.1,4.3h-32c0.3,4.7,4.1,7.9,10.2,7.9c6.2,0,10.4-2.4,13.3-4.7h0.7l4.6,11.9
                                        ...
                                        <path d="M369.9,57.3l-5.1,11.3h-0.7c-4.1-4.5-9.8-6.8-14.2-6.8c-3.7,0-5.1,1.6-5.1,3.2c0,2.1,0.8,2.4,11.1,4.9
                                        ...
                                        <path d="M416.2,57.3l-5.1,11.3h-0.7c-4.1-4.5-9.8-6.8-14.2-6.8c-3.7,0-5.1,1.6-5.1,3.2c0,2.1,0.8,2.4,11.1,4.9
                                            c9.6,2.3,15.9,6,15.9,15.3c0,9.7-6.8,15-18.6,15c-11.7,0-20.1-4.4-23.4-7.9l5.4-12.1h0.7c4.2,3.5,9.4,6.9,16.8,6.9
                                            c4.4,0,5.2-1.2,5.2-2.8c0-1.6-0.9-2.5-11.3-5.1c-11.2-2.8-15.5-7.3-15.5-14.6c0-9.1,7.3-14.9,18.2-14.9
                                            C406.1,49.8,414.1,54.7,416.2,57.3z"/>
                                        <path d="M462.8,68.4v30.8h-11.3l-1.2-6.4H450c-2.3,4.1-7.1,7.4-13.9,7.4c-9.3,0-14.1-6-14.1-13.9
                                        ...
                                        <path d="M503.1,57.2h0.3l0.8-6.4h11.2v42.2c0,14.9-8.4,23.1-23.7,23.1c-8.7,0-15.4-2.9-19.5-5.9l4.3-12.3h0.7
                                        ...
                                        <path d="M568.4,75.5c0,1.5-0.1,4.3-0.1,4.3h-32c0.3,4.7,4.1,7.9,10.2,7.9c6.2,0,10.4-2.4,13.3-4.7h0.7L565,95
                                        ...
                                        <path d="M608.5,38.8c11.9,0,18.3,5.8,18.3,15.5c0,6.9-3.2,11.2-9.5,13.9v0.2c5.7,2.2,9.5,6.9,9.5,14.7
                                        ...
                                        <path d="M650.4,36.1c0,5.2-3.2,9-9,9c-5.8,0-9-3.8-9-9c0-5.3,3.2-8.8,9-8.8C647.2,27.3,650.4,30.8,650.4,36.1z
                                            M634.2,99.2V50.8h14.2v48.3H634.2z"/>
                                        <path d="M690.4,53.8l-2.1,13h-0.7c-1.4-1.5-3.5-2.9-6.6-2.9c-5.7,0-9,5.2-9,13.9v21.4h-14.2V50.8h11.7l0.8,6.4h0.3
                                            c2.6-5.2,6.6-7.4,11-7.4C685,49.8,688.6,51.1,690.4,53.8z"/>
                                        <path d="M728.7,99.2l-1.2-6.4h-0.3c-2.8,4.4-7,7.4-14.7,7.4c-13,0-21.2-10.4-21.2-24.5c0-14.5,8.6-25.9,21.6-25.9
                                ...
                                <path d="M147.6,24.7c-6.6,0-12.5,3.3-16.1,8.3L107.2,67c-0.9,1.3-2.4,2.1-4,2.1c-2.7,0-4.9-2.2-4.9-4.9
        ...
        message: (color) => <svg width="18px" height="18px" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg" stroke={color}>
                            <g strokeWidth="180" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M561 768.74h1038"></path>
                                <path d="M561 1210.25h1038" strokeDasharray="6,3"></path>
                                <path d="M1218.4 1694.65L1054.05 1859 889.7 1711.95H215V302h1730v1409.95h-432.5"></path>
                            </g>
                        </svg>,
        mt: (color) => <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="466.679px" height="466.679px" viewBox="0 0 466.679 466.679"
                        >
                        <g>
        ...
        mo: (color) => <svg xmlns="http://www.w3.org/2000/svg" width="466.69px" height="466.69px" viewBox="0 0 466.69 466.69">
                        <g>
